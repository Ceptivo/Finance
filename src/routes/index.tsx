...
import {
  Banknote, TrendingUp, Receipt, Repeat, Target, ArrowUp, ArrowDown,
    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <Link to="/earnings" className="block hover:scale-[1.01] transition">
          <KpiCard label="Income (mo)" value={fmtMoney(incomeMo)} icon={Banknote} sub={[{ label: "YTD", value: fmtMoney(incomeYr) }]} />
        </Link>
