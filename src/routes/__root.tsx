...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ceptivo Finance" },
      { name: "description", content: "Ceptivo Finance — ZAR Personal Finance Dashboard — track income, expenses, subscriptions, and every side business in one place." },
      { name: "theme-color", content: "#000000" },
      { property: "og:title", content: "Personal Finance Hub" },
      { property: "og:description", content: "Ceptivo Finance — ZAR Personal Finance Dashboard — track income, expenses, subscriptions, and every side business in one place." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Personal Finance Hub" },
      { name: "twitter:description", content: "Ceptivo Finance — ZAR Personal Finance Dashboard — track income, expenses, subscriptions, and every side business in one place." },
