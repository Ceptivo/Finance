...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Personal Ceptivo Finance App" },
      ...
      { property: "og:title", content: "Personal Ceptivo Finance App" },
      ...
      { name: "twitter:title", content: "Personal Ceptivo Finance App" },
...
function RootComponent() {
  ...
  // Register the PWA service worker (production only — it would fight Vite HMR in dev).
  useEffect(() => {
